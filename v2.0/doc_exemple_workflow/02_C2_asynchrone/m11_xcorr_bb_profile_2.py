...
#compute C1 between the backbone and the 2nd profile : 

date1 = int(UTCDateTime(2020,1,1,0,0,0).timestamp)
date2 = int(UTCDateTime(2020,12,31,0,0,0).timestamp)

path_list= ['data_25.0hz/daily/BB', 'data_25.0hz/daily/profile_2'] #, 'data_5.0hz/daily/IT']
in_ = {}
