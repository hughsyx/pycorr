...
data_path                = './data_4.0hz' # archive to process
...
in_['recipe']            = ['_filter','_clipping','_whitening'] # the list of function/method you want to apply
