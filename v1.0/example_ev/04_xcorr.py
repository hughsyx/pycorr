...
in_['tag']               = 'globs' # output label (opt)
...
in_['time_win']          = 3600*5 # time window to correlate in sec

############## CC PARAMS
in_['cc_maxlag']         = 1000. # [s], correlations will corresponds to cc_maxlag*2*fe+1 samples 
