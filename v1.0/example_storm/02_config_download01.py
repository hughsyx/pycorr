...
in_['tag']            = 'glob_01' # subdirectory name for the output /data_*freq*Hz/dauly/**tag**/**year**/
in_['station_list']   = 'stations01.txt' # input station file from 00_get_stations.py or other
