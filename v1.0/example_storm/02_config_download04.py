...
in_['tag']            = 'glob_04' # subdirectory name for the output /data_*freq*Hz/dauly/**tag**/**year**/
in_['station_list']   = 'stations04.txt' # input station file from 00_get_stations.py or other
