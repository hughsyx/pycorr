...
in_['tag']            = 'glob_02' # subdirectory name for the output /data_*freq*Hz/dauly/**tag**/**year**/
in_['station_list']   = 'stations02.txt' # input station file from 00_get_stations.py or other
