...
in_['ch']             = ['HH'] # ['ch1','ch2',...] It will try in this order. Better to start from the lower sampling rate ['LH','BH','HH'...]
in_['cmp']            = ['Z','E','N'] # ['cmp1','cmp2',...]
in_['tag']            = 'cifalps' # subdirectory name for the output /data_*freq*Hz/dauly/**tag**/**year**/
