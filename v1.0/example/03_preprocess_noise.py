...
#        _yourown       : whatever you add in m01_noise_processing module

in_['recipe']            = ['_filter','_seg_in','_clipping','_whitening']
...
arg_filter = {
     'type'  : 'bp' # bp, hp or lp
    ,'f1'    : 1/300.0 # lower corner freq for bp and lp
...
arg_clipping = {
     'treshold' : 5. #3.5 # treshold * std
    ,'replace'  : 5. #3.5 # replace * std
