...
date2 = int(UTCDateTime(2018,5,16,0,0).timestamp) # to
in_['date']              = range(date1,date2+1,86400)
in_['hr1']               = list(np.linspace(0,24-4,6)) # if so  hour of the beginning of each segments 
in_['hr2']               = list(np.linspace(4,24,6)) # hour of the end of each segment
